...
import { StorageOptions, S3Authorization } from '../../common/types';
import { getISODate, getFormatDate } from '../../common/utils';
...
export class StorageService {
   ...
   private getSigningKey() {
      const dateKey = this.HMACSHA256(
         'AWS4' + this.configService.getOrThrow('S3_SECRET_KEY'),
         getFormatDate()
      );
   ...
   private HMACSHA256(
      ...
      const hmac = crypto.createHmac('sha256', key).update(message, 'utf-8');
